        ...
        req.on('end', () => {
            ...
            if (pathname === '/api/health' && method === 'GET') {
                ...
                return res.end(JSON.stringify({
                    status: 'online',
                    database: 'connected (database.json)',
            ...
            if (pathname === '/api/auth/login' && method === 'POST') {
                ...
                if (username === creds.username && password === creds.password) {
                    res.writeHead(200, { 'Content-Type': 'application/json' });
                    return res.end(JSON.stringify({ success: true, username: creds.username }));
                } else {
            ...
            if (pathname === '/api/auth/setup' && method === 'POST') {
                ...
                saveDb(db);
                res.writeHead(200, { 'Content-Type': 'application/json' });
                return res.end(JSON.stringify({ success: true, auth: db.auth }));
            }

            // 3. Leads API
            if (pathname === '/api/leads' && method === 'GET') {
                res.writeHead(200, { 'Content-Type': 'application/json' });
                return res.end(JSON.stringify(db.leads));
            }
            ...
            if (pathname === '/api/leads' && method === 'POST') {
                ...
                return res.end(JSON.stringify(newLead));
            }
...
server.listen(PORT, () => {
    console.log(`==================================================`);
    console.log(`MagikDesign Server running at http://localhost:${PORT}`);
